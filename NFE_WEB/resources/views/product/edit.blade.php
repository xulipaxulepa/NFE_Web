...
@section('title')- @lang('fields.product_title_edit') #{{ $product->id }} @endsection

@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card m-b-30">
                {{ Form::model($product, ['route' => ['product.update', $product], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'editForm']) }}
                <div class="card-body">
                            ...
                            <a href="#" data-toggle="modal" data-target="#modalPhoto">
                                <div class="img-responsive img-thumbnail" style="width: 100%; height: 215px">
                                    <img id="visualizar_img"
                                         src="{{ asset(!is_null($product->photo) ? 'upload/photo_product/'.$product->photo_mini : 'sem_imagem.jpg') }}"
                ...
                <div class="modal-body" align="center">
                    <div class="img-responsive img-thumbnail" style="width: 75%; height: 275px">
                        <img id="visualizar_img_modal"
                             src="{{ asset(!is_null($product->photo) ? 'upload/photo_product/'.$product->photo : 'sem_imagem.jpg') }}"
                             style="height: 100%; width: 100%" class="img-responsive img-thumbnail"/>
                    </div>
                </div>
                <div class="modal-footer">
...
@section('script')
    <script>
        ...
        function allNcm() {
            if(searchCfop == null || searchNcm.length == 0) {
