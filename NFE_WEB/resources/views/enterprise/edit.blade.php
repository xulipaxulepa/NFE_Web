...
@section('title')- @lang('fields.enterprise_title_edit') #{{ $enterprise->id }} @endsection

@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card m-b-30">
                {{ Form::model($enterprise, ['route' => ['enterprise.update', $enterprise], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'editForm']) }}
                <div class="card-body">
        ...
        jQuery.validator.addMethod("uniqueCnpj", function (value, element, config) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.data == null || data.data.id == '{{ $enterprise->id }}') {
                        status = true;
                    }
                }, error: function (data) {
