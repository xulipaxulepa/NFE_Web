...
@section('title')- @lang("fields.note_title_index") @endsection
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <h4 class="mt-0 header-title">
                        <a href="{{ url('note/create') }}" class="btn btn-sm {{ (\App\Model\EnterpriseNote::where('enterprise', Session::get('enterprise')->id)->first()->amount > \App\Model\Note::where('enterprise', Session::get('enterprise')->id)->count()) ? "btn-success" : "btn-dark disabled" }}">@lang('fields.btn_register_new')</a>
...
@section('script')
    <script>
        ...
        function allNotes() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('server/note_all') }}?page=" + page,
                headers: {
