...
@section('title')- @lang('fields.user_title_edit') @endsection

@section('content')
    <div class="row">
        <div class="col-lg-6">
            <div class="card m-b-30">
                {{ Form::model($user, ['route' => ['user.update', $user], 'method' => 'PUT', 'id' => 'editForm']) }}
                <div class="card-body">
        ...
        jQuery.validator.addMethod("uniqueEmail", function (value, element, config) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.data == null || data.data.id == "{{ $user->id }}") {
                        status = true;
                    }
                }, error: function (data) {
