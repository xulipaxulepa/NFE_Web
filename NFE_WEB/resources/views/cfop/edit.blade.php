...
@section('title')- @lang('fields.cfop_title_edit') #{{ $cfop->id }} @endsection

@section('content')
    <div class="row">
        <div class="col-lg-6">
            <div class="card m-b-30">
                {{ Form::model($cfop, ['route' => ['cfop.update', $cfop], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'editForm']) }}
                <div class="card-body">
        ...
        jQuery.validator.addMethod("uniqueCode", function (value, element, config) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.data == null || data.data.id == "{{ $cfop->id }}") {
                        status = true;
                    }
                }, error: function (data) {
